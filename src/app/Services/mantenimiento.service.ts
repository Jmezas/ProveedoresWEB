...
export class MantenimientoService {
  ...
  CreateTermino(params: any) {
    return this.http.post(environment.URL + 'api/Mantenimiento/termino', params);
  }
  Createtenor1(params: any) {
    return this.http.post(environment.URL + 'api/Mantenimiento/Mensajeria', params);
  }
  GetCombo(params: any) {
  ...
  GetUsuarios(params: any) {
    return this.http.get<usuario[]>(environment.URL + 'api/Mantenimiento/obtenerUsuario?codigo=' + params);
  }
  EliminarData(params: any) {
    return this.http.post(environment.URL + 'api/Mantenimiento/elimiarData', params);
  }

  ObtenerData(params: any) {
    return this.http.post(environment.URL + 'api/Mantenimiento/ObtenerData', params);
  }
}
